...
describe('Main', () => {
  ...
  it('should pass a string from JS to WASM, and reverse it', async () => {
    ...
    (module
      ...
      (func (export "reverse") (param $sref i32) (result i32)
        get_local $sref
      )
    )`;
    ...
    const dorinString = wasmModule.createString('Dorin', 5);
    const result = wasmModule.readString(wasmModule.reverse(dorinString));

    expect(result).toEqual('Dorin');
  });
